    ...
    useEffect(()=>{
        ...
        const render = async () => {
            ...
            if(workerProps){
                ...
                frontCtx.globalCompositeOperation = "source-in";
                if(strict){
                    frontCtx.drawImage(srcCache, 0, 0,  front.width, front.height)
                }else{
                    frontCtx.drawImage(src, 0, 0,  front.width, front.height)
                }
                var bgs = document.createElement("img");
                bgs.src = "./static/background/background6.jpg";
                frontCtx.globalCompositeOperation = "destination-over"
                frontCtx.drawImage(bgs,0,0,front.width,front.height)
                frontCtx.globalCompositeOperation = "destination-over";      
